...
* Java: Developing cross-platform applications and enterprise-level software.
  ...
  <h4>Step into my portfolio and witness the fusion of creativity and technical skills!<br> 
    Explore a world where captivating designs, intuitive user experiences, and powerful programming come together. <br> 
    With a diverse skill set ranging from graphic design to programming languages, <br> 
